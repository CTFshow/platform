...
=======
eval("\n\n__webpack_require__(/*! ./main */ \"./CTFd/themes/admin/assets/js/pages/main.js\");\n\nvar _CTFd = _interopRequireDefault(__webpack_require__(/*! core/CTFd */ \"./CTFd/themes/pages/assets/js/CTFd.js\"));\n\nvar _jquery = _interopRequireDefault(__webpack_require__(/*! jquery */ \"./node_modules/jquery/dist/jquery.js\"));\n\nvar _ezq = __webpack_require__(/*! core/ezq */ \"./CTFd/themes/pages/assets/js/ezq.js\");\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nconst api_func = {\n  users: (x, y) => _CTFd.default.api.patch_user_public({\n    userId: x\n  }, y),\n  teams: (x, y) => _CTFd.default.api.patch_team_public({\n    teamId: x\n  }, y)\n};\n\nfunction toggleAccount() {\n  const $btn = (0, _jquery.default)(this);\n  const id = $btn.data(\"account-id\");\n  const state = $btn.data(\"state\");\n  let hidden = undefined;\n\n  if (state === \"visible\") {\n    hidden = true;\n  } else if (state === \"hidden\") {\n    hidden = false;\n  }\n\n  const params = {\n    hidden: hidden\n  };\n\n  api_func[_CTFd.default.config.userMode](id, params).then(response => {\n    if (response.success) {\n      if (hidden) {\n        $btn.data(\"state\", \"hidden\");\n        $btn.addClass(\"btn-danger\").removeClass(\"btn-success\");\n        $btn.text(\"Hidden\");\n      } else {\n        $btn.data(\"state\", \"visible\");\n        $btn.addClass(\"btn-success\").removeClass(\"btn-danger\");\n        $btn.text(\"Visible\");\n      }\n    }\n  });\n}\n\nfunction toggleSelectedAccounts(accountIDs, action) {\n  const params = {\n    hidden: action === \"hidden\" ? true : false\n  };\n  const reqs = [];\n\n  for (var accId of accountIDs) {\n    reqs.push(api_func[_CTFd.default.config.userMode](accId, params));\n  }\n\n  Promise.all(reqs).then(_responses => {\n    window.location.reload();\n  });\n}\n\nfunction bulkToggleAccounts(_event) {\n  let accountIDs = (0, _jquery.default)(\"input[data-account-id]:checked\").map(function () {\n    return (0, _jquery.default)(this).data(\"account-id\");\n  });\n  (0, _ezq.ezAlert)({\n    title: \"Toggle Visibility\",\n    body: (0, _jquery.default)(`\n    <form id=\"scoreboard-bulk-edit\">\n      <div class=\"form-group\">\n        <label>Visibility</label>\n        <select name=\"visibility\" data-initial=\"\">\n          <option value=\"\">--</option>\n          <option value=\"visible\">Visible</option>\n          <option value=\"hidden\">Hidden</option>\n        </select>\n      </div>\n    </form>\n    `),\n    button: \"Submit\",\n    success: function success() {\n      let data = (0, _jquery.default)(\"#scoreboard-bulk-edit\").serializeJSON(true);\n      let state = data.visibility;\n      toggleSelectedAccounts(accountIDs, state);\n    }\n  });\n}\n\n(0, _jquery.default)(() => {\n  (0, _jquery.default)(\".scoreboard-toggle\").click(toggleAccount);\n  (0, _jquery.default)(\"#scoreboard-edit-button\").click(bulkToggleAccounts);\n});\n\n//# sourceURL=webpack:///./CTFd/themes/admin/assets/js/pages/scoreboard.js?");
>>>>>>> Stashed changes
